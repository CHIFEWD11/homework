...
$('body').find('.purplebox').removeClass('purplebox');
...
$('#reset').on('click', function(){
	$('header, .box').hide(); //hides these elements first so you can see them fade in
	$('body').find('.selected').removeClass('selected');
	$('header, footer, .box').fadeIn(2000);
});
